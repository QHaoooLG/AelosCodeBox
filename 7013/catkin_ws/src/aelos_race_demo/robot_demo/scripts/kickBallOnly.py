...
color_dist = {'red': {'Lower': np.array([0, 160, 100]), 'Upper': np.array([180, 255, 250])},
              ...
              'ball_red': {'Lower': np.array([1 , 121 , 80]), 'Upper': np.array([9 , 215 , 136])},
              'blue_hole': {'Lower': np.array([91 , 96 , 89]), 'Upper': np.array([115 , 193 , 187])},
                ...
                if hole_Angle <=0:
                    ...
                    if hole_Angle > -86:
                        if hole_Angle >= -82:
                            ...
                            print("381L4 大左转一下  turn004L ", hole_Angle,"--y ",Chest_ball_y)
                            ...
                            if Chest_ball_y > 410:
                                ...
                                angle_dis_count = 0
                            elif Chest_ball_y < 370:
                                print("427L4 需要前挪一点 Forwalk00 ",Chest_ball_y)
                                action_append("Forwalk00")
                                angle_dis_count = 0
                                
                            print("397L4 左转一下  turn001L ", hole_Angle,"--y ",Chest_ball_y)
                ...
                if hole_Angle >0:
                    ...
                    if hole_Angle < 86:
                        if hole_Angle <= 82:
                            ...
                            print("250L4 大右转一下 turn004R ", hole_Angle,"--y ",Chest_ball_y)
                            ...
                            print("352L4 右转一下 turn001R ", hole_Angle,"--y ",Chest_ball_y)
...
def kick_ball(cmd_ctrl):
    ...
    while state == 7:
        if 0<=step < 8: #踢球的七步
            ...
            cv2.imwrite('./hole_mask.jpg', Hole_Imask)
          ...
          # chest 红球处理
            ...
            cv2.imwrite('./ball_mask.jpg', Chest_Ball_Imask)
